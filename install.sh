...
sudo apt install -y dialog mtools dosfstools avahi-daemon acpi acpid gvfs-backends xfce4-power-manager timeshift bluez blueman
...
sudo apt install -y picom numlockx rofi dunst kitty libnotify-bin unzip policykit-1-gnome scrot mousepad
...
cd ~/.config/suckless
tools=( "dmenu" "st" "slstatus" "slock" "tabbed" )
for tool in ${tools[@]}
do 
